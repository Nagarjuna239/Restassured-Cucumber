Feature: Verify partial Update Booking API Service
  ...
  Scenario Outline: Verify the partial Update Booking service
    ...
    Examples: 
      ...
      | partialUpdateBooking-Update Lastname  | https://restful-booker.herokuapp.com/auth | admin    | password123 | https://restful-booker.herokuapp.com | /booking/19533 | Jame      | Bro      |            200 |
