Feature: Verify Update Booking API Service
  ...
  Scenario Outline: Verify the Update Booking service
    ...
    Examples: 
      ...
      | UpdateBooking-200 first  | https://restful-booker.herokuapp.com/auth | admin    | password123 | https://restful-booker.herokuapp.com | /booking/1278  | Jim       | Brown    |        123 | false       | 2018-01-01 | 2019-01-01 | Breakfast       |            200 |
      | UpdateBooking-200 second | https://restful-booker.herokuapp.com/auth | admin    | password123 | https://restful-booker.herokuapp.com | /booking/19533 | Jim       | Brown    |        134 | false       | 2018-01-01 | 2019-01-01 | Breakfast       |            405 |
